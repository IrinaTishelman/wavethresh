...
\usage{
\method{threshold}{wst}(wst, levels = 3:(nlevels(wst) - 1), dev = madmad, policy = 
...
\item{levels}{a vector of integers which determines which scale levels are thresholded in the decomposition. Each integer in the vector must refer to a valid level in the \code{\link{wst}} object supplied. This is usually any integer from 0 to \code{\link{nlevels}}(wst)-1 inclusive. Only the levels in this vector contribute to the computation of the threshold and its application. }
